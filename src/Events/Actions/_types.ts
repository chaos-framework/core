export enum ActionType {
  ...
  UNPUBLISH_PLAYER_ACTION = 'UNPUBLISH_PLAYER_ACTION',
  OWN_ENTITY_ACTION = 'OWN_ENTITY_ACTION',
  CHANGE_TURN_ACTION = 'CHANGE_TURN_ACTION',
  PUBLISH_CHUNK_ACTION = 'PUBLISH_CHUNK_ACTION',
  UNPUBLISH_CHUNK_ACTION = 'UNPUBLISH_CHUNK_ACTION',
  PROPERTY_THRESHOLD_ACTION = 'PROPERTY_THRESHOLD_ACTION',
  MESSAGE = 'MESSAGE',
  LOGICAL = 'LOGICAL'
}
