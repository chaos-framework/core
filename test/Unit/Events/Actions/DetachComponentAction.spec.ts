...
import { DetachComponentAction, Entity, Chaos, Component, ActionType, Vector } from '../../../../src/internal.js';
...
describe('DetachComponentAction', () => {
  ...
  it('Can deserialize from proper json', () => {
    const json: DetachComponentAction.Serialized = { target: target.id, component: component.id, permitted: true, actionType: ActionType.DETACH_COMPONENT_ACTION };
