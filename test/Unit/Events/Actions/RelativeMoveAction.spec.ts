...
import { RelativeMoveAction, Entity, Game, Vector } from '../../../../src/internal';
...
describe('MoveAction', () => {
  ...
  it('Can deserialize from an object', () => {
    const json: RelativeMoveAction.Serialized = { target: target.id, amount: new Vector(1, 0).serialize(), permitted: true }
